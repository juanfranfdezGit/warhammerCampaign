...
import destacamentos from "../../datas/armies/puñosFaction.json";
        ...
        <div className="doctrinasSection destacamentosSection">
          ...
          {destacamentoData.destacamentos.map((destacamento) => (
            <div key={destacamento.id}>
              ...
              <p>{destacamento.description}</p>
              <h4>{destacamento.doc1title}</h4>
              <p>{destacamento.doc1}</p>
              <h4>{destacamento.doc2title}</h4>
              <p>{destacamento.doc2}</p>
              <h4>{destacamento.doc3title}</h4>
              <p>{destacamento.doc3}</p>
